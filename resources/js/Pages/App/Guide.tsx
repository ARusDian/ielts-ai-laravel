        ...
        <div className="row">
            ...
            <div className="card h-100">
              <div className="row g-0">
                <div className="col-md-2">
                  <img src={`${asset("root", "assets/guide/1.png")}`} className="img-fluid" alt="Step 1" />
                </div>
          ...
          <div className="col-md-12 mb-4">
            <div className="card h-100">
              <div className="row g-0">
                <div className="col-md-2">
                  <img src={`${asset("root", "assets/guide/2.png")}`} className="img-fluid" alt="Step 2" />
                </div>
                <div className="col-md-10">
                  <div className="card-body">
          ...
          <div className="col-md-12 mb-4">
            <div className="card h-100">
              <div className="row g-0">
                <div className="col-md-2">
                  <img src={`${asset("root", "assets/guide/3.png")}`} className="img-fluid" alt="Step 3" />
                </div>
                <div className="col-md-10">
                  <div className="card-body">
          ...
          <div className="col-md-12 mb-4">
            <div className="card h-100">
              <div className="row g-0">
                <div className="col-md-2">
                  <img src={`${asset("root", "assets/guide/4.png")}`} className="img-fluid" alt="Step 4" />
                </div>
                <div className="col-md-10">
                  <div className="card-body">
          ...
          <div className="col-md-12 mb-4">
            <div className="card h-100">
              <div className="row g-0">
                <div className="col-md-2">
                  <img src={`${asset("root", "assets/guide/5.png")}`} className="img-fluid" alt="Step 5" />
                </div>
                <div className="col-md-10">
                  <div className="card-body">
          ...
          <div className="col-md-12 mb-4">
            <div className="card h-100">
              <div className="row g-0">
                <div className="col-md-2">
                  <img src={`${asset("root", "assets/guide/6.png")}`} className="img-fluid" alt="Step 6" />
                </div>
                <div className="col-md-10">
                  <div className="card-body">
          ...
          <div className="col-md-12 mb-4">
            <div className="card h-100">
              <div className="row g-0">
                <div className="col-md-2">
                  <img src={`${asset("root", "assets/guide/7.png")}`} className="img-fluid" alt="Step 7" />
                </div>
                <div className="col-md-10">
                  <div className="card-body">
